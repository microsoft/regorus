...
- Rule-conflict diagnostics now retain the current source envelope and identify the previous rule by file, line, and column without nesting a second diagnostic. RVM conflict result semantics are unchanged.
