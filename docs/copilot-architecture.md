...
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐          │
│  │ Skills (6)   │  │ Agents (17)  │  │ Knowledge    │          │
│  │ Task workflows│  │ Role personas│  │ Files (21)   │          │
│  └──────────────┘  └──────────────┘  └──────────────┘          │
│                                                                 │
...
and provide a reference table of all 21 knowledge files.
...
| Safety & security | `policy-evaluation-security`, `ffi-boundary`, `feature-composition`, `workflow-security` |
