...
// Azure Policy definitions can have deeply nested template expressions on a
// single line, so this must be generous enough for real-world policies.
pub const DEFAULT_MAX_COL: NonZeroU32 = NonZeroU32::new(8192).unwrap();
