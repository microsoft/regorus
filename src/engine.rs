...
use crate::utils::limits::{global_execution_timer_config, ExecutionTimerConfig};
use crate::value::*;
use crate::*;
...
impl Engine {
    fn effective_execution_timer_config(&self) -> ExecutionTimerConfig {
        self.execution_timer_config
            .or_else(global_execution_timer_config)
            .unwrap_or_default()
    }
    ...
    ///     limit: Some(Duration::from_millis(5)),
    ///     check_interval: NonZeroU32::new(1).unwrap(),
    /// };
    /// set_global_execution_timer_config(Some(global));
    ///
